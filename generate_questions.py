...
def main():
    ...
    parser.add_argument(
        "-n", "--number_of_questions", required=False, default=750, type=int, help="Number of questions to generate."
    )
    parser.add_argument(
        "-o", "--output_file", required=False, default="questions.json", type=str, help="Path to the output file."
    )
    categories = ["wh-questions", "yes/no questions", "explain", "create"]
    prompts = ["Create 50 wh-questions about general topics. Example: What is the capital of France? Cover as many topics and types of questions as possible. Don't repeat questions.",
                ...
                "Create 50 general topics. Example: Create a poem about the universe. Cover as many topics and types of questions as possible. Don't repeat questions."]
